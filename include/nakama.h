...
extern "C"
{
	...
	typedef NkMapAny (*NkLoggerFieldsFn)(const void *ptr);
	...
	typedef struct NkLogger (*NkLoggerWithFieldsFn)(const void *ptr, NkMapAny fields);
	...
	typedef int (*NkModuleAuthenticateGenerateTokenFn)(
		NkString userid, NkString username, NkI64 expiry, NkMapString vars, NkString **outtoken, NkI64 **outexpiry,
		NkString **outerror);
	...
	typedef int (*NkModuleAccountGetIdFn)(const void *ptr, const NkContext *ctx,
										  NkString userid, NkAccount **outaccount,
										  NkString **outerror);

	typedef int (*NkModuleAccountsGetIdFn)(const void *ptr, const NkContext *ctx, NkString *userids, NkU32 numuserids,
										   NkAccount **outaccounts, NkU32 **outnumaccounts,
										   NkString **outerror);

	typedef int (*NkModuleAccountUpdateIdFn)(const void *ptr, const NkContext *ctx,
											 NkString userid, NkString username, NkMapAny metadata, NkString displayname, NkString timezone, NkString location, NkString langtag, NkString avatarurl,
											 NkString **outerror);

	typedef int (*NkModuleAccountDeleteIdFn)(const void *ptr, const NkContext *ctx,
											 NkString userid, bool recorded,
											 NkString **outerror);

	typedef int (*NkModuleAccountExportIdFn)(const void *ptr, const NkContext *ctx,
											 NkString userid, NkString **outaccount,
											 NkString **outerror);
	...
	typedef int (*NkModuleUsersGetFn)(const void *ptr, const NkContext *ctx, NkString *keys, NkU32 numkeys,
									  NkUser **outusers, NkU32 **outnumusers,
									  NkString **outerror);

	typedef int (*NkModuleUsersBanFn)(const void *ptr, const NkContext *ctx, NkString *userids, NkU32 numids,
									  NkString **outerror);

	typedef int (*NkModuleLinkFn)(const void *ptr, const NkContext *ctx,
								  NkString userid, NkString linkid,
								  NkString **outerror);

	typedef int (*NkModuleLinkEmailFn)(const void *ptr, const NkContext *ctx,
									   NkString userid, NkString email, NkString password,
									   NkString **outerror);

	typedef int (*NkModuleLinkFacebookFn)(const void *ptr, const NkContext *ctx,
										  NkString userid, NkString username, NkString token, bool importfriends,
										  NkString **outerror);

	typedef int (*NkModuleLinkGameCenterFn)(const void *ptr, const NkContext *ctx,
											NkString userid, NkString playerid, NkString bundleid, NkI64 timestamp, NkString salt, NkString signature, NkString publickeyurl,
											NkString **outerror);
	...
	typedef int (*NkModuleStreamUserListFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
											bool includehidden, bool includenothidden, NkPresence **outpresences, NkU32 **outnumpresences,
											NkString **outerror);
	...
	typedef int (*NkModuleStreamUserGetFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
										   NkString userid, NkString sessionid, NkPresenceMeta **outmeta,
										   NkString **outerror);

	typedef int (*NkModuleStreamUserJoinFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
											NkString userid, NkString sessionid, bool hidden, bool persistence, NkString status, bool **outjoined,
											NkString **outerror);

	typedef int (*NkModuleStreamUserUpdateFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
											  NkString userid, NkString sessionid, bool hidden, bool persistence, NkString status,
											  NkString **outerror);

	typedef int (*NkModuleStreamUserLeaveFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
											 NkString userid, NkString sessionid,
											 NkString **outerror);

	typedef int (*NkModuleStreamUserKickFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
											NkPresence presence,
											NkString **outerror);

	typedef int (*NkModuleStreamCountFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
										 NkU64 **outcount,
										 NkString **outerror);

	typedef int (*NkModuleStreamCloseFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
										 NkString **outerror);

	typedef int (*NkModuleStreamSendFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
										NkString data, NkPresence *presences, NkU32 numpresences, bool reliable,
										NkString **outerror);
	...
	typedef int (*NkModuleStreamSendRawFn)(const void *ptr, NkU8 mode, NkString subject, NkString subcontext, NkString label,
										   NkEnvelope msg, NkPresence *presences, NkU32 numpresences, bool reliable,
										   NkString **outerror);

	typedef int (*NkModuleSessionDisconnectFn)(const void *ptr, const NkContext *ctx,
											   NkString sessionid,
											   NkString **outerror);

	typedef int (*NkModuleMatchCreateFn)(const void *ptr, const NkContext *ctx,
										 NkString module, NkMapAny params,
										 NkString **outmatchid,
										 NkString **outerror);
	...
	typedef int (*NkModuleMatchGetFn)(const void *ptr, const NkContext *ctx,
									  NkString id, NkMatch **outmatch,
									  NkString **outerror);

	typedef int (*NkModuleMatchListFn)(const void *ptr, const NkContext *ctx,
									   NkU32 limit, bool authoritative, NkString label, const NkU32 *minsize, const NkU32 *maxsize, NkString query,
									   NkMatch **outmatches, NkU32 **outnummatches,
									   NkString **outerror);

	typedef int (*NkModuleNotificationSendFn)(const void *ptr, const NkContext *ctx,
											  NkString userid, NkString subject, NkMapAny content, NkU64 code, NkString sender, bool persistent,
											  NkString **outerror);
	...
	typedef int (*NkModuleNotificationsSendFn)(const void *ptr, const NkContext *ctx, const NkNotificationSend *notifications, NkU32 numnotifications,
											   NkString **outerror);

	typedef int (*NkModuleWalletUpdateFn)(const void *ptr, const NkContext *ctx, NkString userid,
										  NkMapI64 changeset, NkMapAny metadata, bool updateledger,
										  NkMapI64 **outupdated, NkMapI64 **outprevious,
										  NkString **outerror);
	...
	typedef int (*NkModuleWalletsUpdateFn)(const void *ptr, const NkContext *ctx, const NkWalletUpdate *updates, NkU32 numupdates,
										   bool updateledger, NkWalletUpdateResult **outresults, NkU32 **outnumresults,
										   NkString **outerror);
	...
	typedef int (*NkModuleWalletLedgerUpdateFn)(const void *ptr, const NkContext *ctx, NkString itemid, NkMapAny metadata,
												NkWalletLedgerItem **outitem,
												NkString **outerror);

	typedef int (*NkModuleWalletLedgerListFn)(const void *ptr, const NkContext *ctx,
											  NkString userid, NkU32 limit, NkString cursor,
											  NkWalletLedgerItem **outitems, NkU32 **outnumitems,
											  NkString **outcursor, NkString **outerror);
	...
	typedef int (*NkModuleStorageListFn)(const void *ptr, const NkContext *ctx,
										 NkString userid, NkString collection, NkU32 limit, NkString cursor,
										 NkStorageObject **outobjs, NkU32 **outnumobjs,
										 NkString **outcursor, NkString **outerror);
	...
	typedef int (*NkModuleStorageReadFn)(const void *ptr, const NkContext *ctx,
										 const NkStorageRead *reads, NkU32 numreads,
										 NkStorageObject **outobjs, NkU32 **outnumobjs,
										 NkString **outerror);
	...
	typedef int (*NkModuleStorageWriteFn)(const void *ptr, const NkContext *ctx,
										  const NkStorageWrite *writes, NkU32 numwrites,
										  NkStorageObjectAck **outacks, NkU32 **outnumacks,
										  NkString **outerror);
	...
	typedef int (*NkModuleStorageDeleteFn)(const void *ptr, const NkContext *ctx,
										   const NkStorageDelete *deletes, NkU32 numdeletes,
										   NkString **outerror);
	...
	typedef int (*NkModuleMultiUpdateFn)(const void *ptr, const NkContext *ctx,
										 const NkAccountUpdate *accountupdates, NkU32 numaccountupdates,
										 const NkStorageWrite *storagewrites, NkU32 numstoragewrites,
										 const NkWalletUpdate *walletupdates, NkU32 numwalletupdates,
										 bool updateledger,
										 NkStorageObjectAck **outacks, NkU32 **outnumacks,
										 NkWalletUpdateResult **outresults, NkU32 **outnumresults,
										 NkString **outerror);

	typedef int (*NkModuleLeaderboardCreateFn)(const void *ptr, const NkContext *ctx,
											   NkString id, bool authoritative, NkString sortorder, NkString op, NkString resetschedule,
											   NkMapAny metadata,
											   NkString **outerror);

	typedef int (*NkModuleLeaderboardRecordsListFn)(const void *ptr, const NkContext *ctx,
													NkString id, const NkString *ownerids, NkU32 numownerids, NkU32 limit, NkString cursor, NkI64 expiry,
													NkLeaderboardRecord **outrecords, NkU32 **outnumrecords,
													NkLeaderboardRecord **outownerrecords, NkU32 **outnumownerrecords,
													NkString **outnextcursor, NkString **outprevcursor,
													NkString **outerror);

	typedef int (*NkModuleLeaderboardRecordWriteFn)(const void *ptr, const NkContext *ctx,
													NkString id, NkString ownerid, NkI64 score, NkI64 subscore, NkMapAny metadata,
													NkLeaderboardRecord **outrecord,
													NkString **outerror);

	typedef int (*NkModuleDeleteFn)(const void *ptr, const NkContext *ctx,
									NkString id, NkString ownerid,
									NkString **outerror);

	typedef int (*NkModuleTournamentCreateFn)(const void *ptr, const NkContext *ctx,
											  NkString id, NkString sortorder, NkString resetschedule, NkMapAny metadata, NkString title, NkString description, NkU32 category, NkU32 starttime, NkU32 endtime, NkU32 duration, NkU32 maxsize, NkU32 maxnumscore,
											  bool joinrequired,
											  NkString **outerror);

	typedef int (*NkModuleTournamentAddAttemptFn)(const void *ptr, const NkContext *ctx,
												  NkString id, NkString ownerid, NkU64 count,
												  NkString **outerror);

	typedef int (*NkModuleTournamentJoinFn)(const void *ptr, const NkContext *ctx,
											NkString id, NkString ownerid, NkString username,
											NkString **outerror);
	...
	typedef int (*NkModuleTournamentsGetIdFn)(const void *ptr, const NkContext *ctx,
											  const NkString *tournamentids, NkU32 numtournamentids,
											  NkTournament **outtournaments, NkU32 **outnumtournaments,
											  NkString **outerror);
	...
	typedef int (*NkModuleTournamentListFn)(const void *ptr, const NkContext *ctx,
											NkU64 catstart, NkU64 catend, NkU64 starttime, NkU64 endtime, NkU32 limit, NkString cursor,
											NkString id, NkTournamentList **outtournaments, NkU32 **outnumtournaments,
											NkString **outerror);
	...
	typedef int (*NkModuleTournamentRecordsListFn)(const void *ptr, const NkContext *ctx,
												   NkString tournamentid, const NkString *ownerids, NkU32 numownerids,
												   NkU32 limit, NkString cursor, NkI64 overrideexpiry,
												   NkLeaderboardRecord **outrecords, NkU32 **outnumrecords,
												   NkLeaderboardRecord **outownerrecords, NkU32 **outnumownerrecords,
												   NkString **outnextcursor, NkString **outprevcursor,
												   NkString **outerror);

	typedef int (*NkModuleTournamentRecordWriteFn)(const void *ptr, const NkContext *ctx,
												   NkString id, NkString ownerid, NkString username, NkI64 score, NkI64 subscore,
												   NkMapAny metadata,
												   NkLeaderboardRecord **outrecord,
												   NkString **outerror);

	typedef int (*NkModuleTournamentRecordsHaystackFn)(const void *ptr, const NkContext *ctx,
													   NkString id, NkString ownerid, NkU32 limit, NkI64 expiry,
													   NkLeaderboardRecord **outrecords, NkU32 **outnumrecords,
													   NkString **outerror);
	...
	typedef int (*NkModuleGroupsGetIdFn)(const void *ptr, const NkContext *ctx,
										 const NkString *groupids, NkU32 numgroupids,
										 NkGroup **outgroups, NkU32 **outnumgroups,
										 NkString **outerror);

	typedef int (*NkModuleGroupCreateFn)(const void *ptr, const NkContext *ctx,
										 NkString userid, NkString name, NkString creatorid, NkString langtag,
										 NkString description, NkString avatarurl, bool open, NkMapAny metadata,
										 NkU32 maxcount,
										 NkGroup **outgroup,
										 NkString **outerror);

	typedef int (*NkModuleGroupUpdateFn)(const void *ptr, const NkContext *ctx,
										 NkString userid, NkString name, NkString creatorid, NkString langtag,
										 NkString description, NkString avatarurl, bool open, NkMapAny metadata,
										 NkU32 maxcount,
										 NkString **outerror);

	typedef int (*NkModuleGroupUserFn)(const void *ptr, const NkContext *ctx,
									   NkString groupid, NkString userid, NkString username,
									   NkString **outerror);

	typedef int (*NkModuleGroupUsersFn)(const void *ptr, const NkContext *ctx,
										NkString groupid, const NkString *userids, NkU32 numuserids,
										NkString **outerror);
	...
	typedef int (*NkModuleGroupUsersListFn)(const void *ptr, const NkContext *ctx,
											NkString groupid, NkU32 limit, NkU32 state, NkString cursor,
											NkGroupUserListGroupUser **outusers, NkU32 **outnumusers,
											NkString **outcursor,
											NkString **outerror);
	...
	typedef int (*NkModuleUserGroupsListFn)(const void *ptr, const NkContext *ctx,
											NkString userid, NkU32 limit, NkU32 state, NkString cursor,
											NkUserGroupListUserGroup **outusers, NkU32 **outnumusers,
											NkString **outcursor,
											NkString **outerror);
	...
	typedef int (*NkModuleFriendsListFn)(const void *ptr, const NkContext *ctx,
										 NkString userid, NkU32 limit, NkU32 state, NkString cursor,
										 NkFriend **outfriends, NkU32 **outnumfriends,
										 NkString **outcursor,
										 NkString **outerror);
	...
	typedef int (*NkModuleEventFn)(const void *ptr, const NkContext *ctx,
								   NkEvent evt,
								   NkString **outerror);
	...
	typedef int (*NkBeforeListGroupUsersCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													NkModule nk, NkListGroupUsersRequest req,
													NkListGroupUsersRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListGroupUsersFn)(const void *ptr,
	...
	typedef int (*NkAfterListGroupUsersCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												   NkModule nk, NkGroupUserList users,
												   NkListGroupUsersRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListGroupUsersFn)(const void *ptr,
	...
	typedef int (*NkBeforeListUserGroupsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													NkModule nk, NkListUserGroupsRequest req,
													NkListUserGroupsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListUserGroupsFn)(const void *ptr,
	...
	typedef int (*NkAfterListUserGroupsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												   NkModule nk, NkUserGroupList users,
												   NkListUserGroupsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListUserGroupsFn)(const void *ptr,
	...
	typedef int (*NkBeforeListGroupsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkListGroupsRequest req,
												NkListGroupsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListGroupsFn)(const void *ptr,
	...
	typedef int (*NkAfterListGroupsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkGroupList users,
											   NkListGroupsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListGroupsFn)(const void *ptr,
	...
	typedef int (*NkBeforeDeleteLeaderboardRecordCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															 NkModule nk, NkDeleteLeaderboardRecordRequest req,
															 NkDeleteLeaderboardRecordRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeDeleteLeaderboardRecordFn)(const void *ptr,
																const NkBeforeDeleteLeaderboardRecordCallbackFn cb,
																NkString **outerror);

	typedef int (*NkAfterDeleteLeaderboardRecordCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															NkModule nk,
															NkDeleteLeaderboardRecordRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterDeleteLeaderboardRecordFn)(const void *ptr,
	...
	typedef int (*NkBeforeListLeaderboardRecordsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															NkModule nk, NkListLeaderboardRecordsRequest req,
															NkListLeaderboardRecordsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListLeaderboardRecordsFn)(const void *ptr,
	...
	typedef int (*NkAfterListLeaderboardRecordsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														   NkModule nk, NkLeaderboardRecordList records,
														   NkListLeaderboardRecordsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListLeaderboardRecordsFn)(const void *ptr,
	...
	typedef int (*NkBeforeWriteLeaderboardRecordCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															NkModule nk, NkWriteLeaderboardRecordRequest req,
															NkWriteLeaderboardRecordRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeWriteLeaderboardRecordFn)(const void *ptr,
															   const NkBeforeWriteLeaderboardRecordCallbackFn cb,
															   NkString **outerror);

	typedef int (*NkAfterWriteLeaderboardRecordCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														   NkModule nk, NkLeaderboardRecord record,
														   NkWriteLeaderboardRecordRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterWriteLeaderboardRecordFn)(const void *ptr,
	...
	typedef int (*NkBeforeListLeaderboardRecordsAroundOwnerCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
																	   NkModule nk, NkListLeaderboardRecordsAroundOwnerRequest req,
																	   NkListLeaderboardRecordsAroundOwnerRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListLeaderboardRecordsAroundOwnerFn)(const void *ptr,
																		  const NkBeforeListLeaderboardRecordsAroundOwnerCallbackFn cb,
																		  NkString **outerror);

	typedef int (*NkAfterListLeaderboardRecordsAroundOwnerCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
																	  NkModule nk, NkLeaderboardRecordList records,
																	  NkListLeaderboardRecordsAroundOwnerRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListLeaderboardRecordsAroundOwnerFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkAppleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkAccountApple account,
											   NkAccountApple **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkAppleFn)(const void *ptr,
												  const NkBeforeLinkAppleCallbackFn cb,
												  NkString **outerror);

	typedef int (*NkAfterLinkAppleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											  NkModule nk, NkAccountApple account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkAppleFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkCustomCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkAccountCustom account,
												NkAccountCustom **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkCustomFn)(const void *ptr,
												   const NkBeforeLinkCustomCallbackFn cb,
												   NkString **outerror);

	typedef int (*NkAfterLinkCustomCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkAccountCustom account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkCustomFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkDeviceCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkAccountDevice account,
												NkAccountDevice **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkDeviceFn)(const void *ptr,
												   const NkBeforeLinkDeviceCallbackFn cb,
												   NkString **outerror);

	typedef int (*NkAfterLinkDeviceCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkAccountDevice account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkDeviceFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkEmailCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkAccountEmail account,
											   NkAccountEmail **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkEmailFn)(const void *ptr,
												  const NkBeforeLinkEmailCallbackFn cb,
												  NkString **outerror);

	typedef int (*NkAfterLinkEmailCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											  NkModule nk, NkAccountEmail account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkEmailFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkFacebookCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												  NkModule nk, NkLinkFacebookRequest req,
												  NkLinkFacebookRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkFacebookFn)(const void *ptr,
													 const NkBeforeLinkFacebookCallbackFn cb,
													 NkString **outerror);

	typedef int (*NkAfterLinkFacebookCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkLinkFacebookRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterLinkFacebookFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkFacebookInstantGameCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															 NkModule nk, NkAccountFacebookInstantGame account,
															 NkAccountFacebookInstantGame **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkFacebookInstantGameFn)(const void *ptr,
																const NkBeforeLinkFacebookInstantGameCallbackFn cb,
																NkString **outerror);

	typedef int (*NkAfterLinkFacebookInstantGameCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															NkModule nk, NkAccountFacebookInstantGame account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkFacebookInstantGameFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkGameCenterCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													NkModule nk, NkAccountGameCenter account,
													NkAccountGameCenter **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkGameCenterFn)(const void *ptr,
													   const NkBeforeLinkGameCenterCallbackFn cb,
													   NkString **outerror);

	typedef int (*NkAfterLinkGameCenterCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												   NkModule nk, NkAccountGameCenter account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkGameCenterFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkGoogleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkAccountGoogle account,
												NkAccountGoogle **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkGoogleFn)(const void *ptr,
												   const NkBeforeLinkGoogleCallbackFn cb,
												   NkString **outerror);

	typedef int (*NkAfterLinkGoogleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkAccountGoogle account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkGoogleFn)(const void *ptr,
	...
	typedef int (*NkBeforeLinkSteamCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											   NkModule nk, NkAccountSteam account,
											   NkAccountSteam **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeLinkSteamFn)(const void *ptr,
												  const NkBeforeLinkSteamCallbackFn cb,
												  NkString **outerror);

	typedef int (*NkAfterLinkSteamCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											  NkModule nk, NkAccountSteam account, NkString **outerror);

	typedef int (*NkInitializerAfterLinkSteamFn)(const void *ptr,
	...
	typedef int (*NkBeforeListMatchesCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkListMatchesRequest req,
												 NkListMatchesRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListMatchesFn)(const void *ptr,
	...
	typedef int (*NkAfterListMatchesCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkMatchList list,
												NkListMatchesRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListMatchesFn)(const void *ptr,
	...
	typedef int (*NkBeforeListNotificationsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													   NkModule nk, NkListNotificationsRequest req,
													   NkListNotificationsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListNotificationsFn)(const void *ptr,
	...
	typedef int (*NkAfterListNotificationsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													  NkModule nk, NkNotificationList list,
													  NkListNotificationsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListNotificationsFn)(const void *ptr,
	...
	typedef int (*NkBeforeDeleteNotificationsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														 NkModule nk, NkDeleteNotificationsRequest req,
														 NkDeleteNotificationsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeDeleteNotificationsFn)(const void *ptr,
															const NkBeforeDeleteNotificationsCallbackFn cb,
															NkString **outerror);

	typedef int (*NkAfterDeleteNotificationsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														NkModule nk,
														NkDeleteNotificationsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterDeleteNotificationsFn)(const void *ptr,
	...
	typedef int (*NkBeforeListStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														NkModule nk, NkListStorageObjectsRequest req,
														NkListStorageObjectsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkAfterListStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													   NkModule nk, NkStorageObjectList list,
													   NkListStorageObjectsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkBeforeReadStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														NkModule nk, NkReadStorageObjectsRequest req,
														NkReadStorageObjectsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeReadStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkAfterReadStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													   NkModule nk, NkStorageObjects objs,
													   NkReadStorageObjectsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterReadStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkBeforeWriteStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														 NkModule nk, NkWriteStorageObjectsRequest req,
														 NkWriteStorageObjectsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeWriteStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkAfterWriteStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														NkModule nk, NkStorageObjectAcks acks,
														NkWriteStorageObjectsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterWriteStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkBeforeDeleteStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														  NkModule nk, NkDeleteStorageObjectsRequest req,
														  NkDeleteStorageObjectsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeDeleteStorageObjectsFn)(const void *ptr,
															 const NkBeforeDeleteStorageObjectsCallbackFn cb,
															 NkString **outerror);

	typedef int (*NkAfterDeleteStorageObjectsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														 NkModule nk,
														 NkDeleteStorageObjectsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterDeleteStorageObjectsFn)(const void *ptr,
	...
	typedef int (*NkBeforeJoinTournamentCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													NkModule nk, NkJoinTournamentRequest req,
													NkJoinTournamentRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeJoinTournamentFn)(const void *ptr,
													   const NkBeforeJoinTournamentCallbackFn cb,
													   NkString **outerror);

	typedef int (*NkAfterJoinTournamentCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												   NkModule nk,
												   NkJoinTournamentRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterJoinTournamentFn)(const void *ptr,
	...
	typedef int (*NkBeforeListTournamentRecordsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														   NkModule nk, NkListTournamentRecordsRequest req,
														   NkListTournamentRecordsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListTournamentRecordsFn)(const void *ptr,
	...
	typedef int (*NkAfterListTournamentRecordsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														  NkModule nk, NkTournamentRecordList list,
														  NkListTournamentRecordsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListTournamentRecordsFn)(const void *ptr,
	...
	typedef int (*NkBeforeListTournamentsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													 NkModule nk, NkListTournamentsRequest req,
													 NkListTournamentsRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListTournamentsFn)(const void *ptr,
														const NkBeforeListTournamentsCallbackFn cb,
														NkString **outerror);

	typedef int (*NkAfterListTournamentsCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													NkModule nk, NkTournamentList list,
													NkListTournamentsRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListTournamentsFn)(const void *ptr,
	...
	typedef int (*NkBeforeWriteTournamentRecordCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														   NkModule nk, NkWriteTournamentRecordRequest req,
														   NkWriteTournamentRecordRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeWriteTournamentRecordFn)(const void *ptr,
															  const NkBeforeWriteTournamentRecordCallbackFn cb,
															  NkString **outerror);

	typedef int (*NkAfterWriteTournamentRecordCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
														  NkModule nk, NkLeaderboardRecord record,
														  NkWriteTournamentRecordRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterWriteTournamentRecordFn)(const void *ptr,
	...
	typedef int (*NkBeforeListTournamentRecordsAroundOwnerCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
																	  NkModule nk, NkListTournamentRecordsAroundOwnerRequest req,
																	  NkListTournamentRecordsAroundOwnerRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeListTournamentRecordsAroundOwnerFn)(const void *ptr,
																		 const NkBeforeListTournamentRecordsAroundOwnerCallbackFn cb,
																		 NkString **outerror);

	typedef int (*NkAfterListTournamentRecordsAroundOwnerCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
																	 NkModule nk, NkTournamentRecordList list,
																	 NkListTournamentRecordsAroundOwnerRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterListTournamentRecordsAroundOwnerFn)(const void *ptr,
																		const NkAfterListTournamentRecordsAroundOwnerCallbackFn cb,
																		NkString **outerror);

	typedef int (*NkBeforeUnlinkAppleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkAccountApple account,
												 NkAccountApple **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkAppleFn)(const void *ptr,
													const NkBeforeUnlinkAppleCallbackFn cb,
													NkString **outerror);

	typedef int (*NkAfterUnlinkAppleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkAccountApple account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkAppleFn)(const void *ptr,
												   const NkAfterUnlinkAppleCallbackFn cb,
												   NkString **outerror);

	typedef int (*NkBeforeUnlinkCustomCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												  NkModule nk, NkAccountCustom account,
												  NkAccountCustom **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkCustomFn)(const void *ptr,
													 const NkBeforeUnlinkCustomCallbackFn cb,
													 NkString **outerror);

	typedef int (*NkAfterUnlinkCustomCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkAccountCustom account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkCustomFn)(const void *ptr,
													const NkAfterUnlinkCustomCallbackFn cb,
													NkString **outerror);

	typedef int (*NkBeforeUnlinkDeviceCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												  NkModule nk, NkAccountDevice account,
												  NkAccountDevice **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkDeviceFn)(const void *ptr,
													 const NkBeforeUnlinkDeviceCallbackFn cb,
													 NkString **outerror);

	typedef int (*NkAfterUnlinkDeviceCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkAccountDevice account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkDeviceFn)(const void *ptr,
													const NkAfterUnlinkDeviceCallbackFn cb,
													NkString **outerror);

	typedef int (*NkBeforeUnlinkEmailCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkAccountEmail account,
												 NkAccountEmail **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkEmailFn)(const void *ptr,
													const NkBeforeUnlinkEmailCallbackFn cb,
													NkString **outerror);

	typedef int (*NkAfterUnlinkEmailCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkAccountEmail account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkEmailFn)(const void *ptr,
	...
	typedef int (*NkBeforeUnlinkFacebookCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													NkModule nk, NkAccountFacebook account,
													NkAccountFacebook **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkFacebookFn)(const void *ptr,
													   const NkBeforeUnlinkFacebookCallbackFn cb,
													   NkString **outerror);

	typedef int (*NkAfterUnlinkFacebookCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												   NkModule nk, NkAccountFacebook account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkFacebookFn)(const void *ptr,
													  const NkAfterUnlinkFacebookCallbackFn cb,
													  NkString **outerror);

	typedef int (*NkBeforeUnlinkFacebookInstantGameCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															   NkModule nk, NkAccountFacebookInstantGame account,
															   NkAccountFacebookInstantGame **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkFacebookInstantGameFn)(const void *ptr,
																  const NkBeforeUnlinkFacebookInstantGameCallbackFn cb,
																  NkString **outerror);

	typedef int (*NkAfterUnlinkFacebookInstantGameCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
															  NkModule nk, NkAccountFacebookInstantGame account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkFacebookInstantGameFn)(const void *ptr,
																 const NkAfterUnlinkFacebookInstantGameCallbackFn cb,
																 NkString **outerror);

	typedef int (*NkBeforeUnlinkGameCenterCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													  NkModule nk, NkAccountGameCenter account,
													  NkAccountGameCenter **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkGameCenterFn)(const void *ptr,
														 const NkBeforeUnlinkGameCenterCallbackFn cb,
														 NkString **outerror);

	typedef int (*NkAfterUnlinkGameCenterCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
													 NkModule nk, NkAccountGameCenter account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkGameCenterFn)(const void *ptr,
														const NkAfterUnlinkGameCenterCallbackFn cb,
														NkString **outerror);

	typedef int (*NkBeforeUnlinkGoogleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												  NkModule nk, NkAccountGoogle account,
												  NkAccountGoogle **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkGoogleFn)(const void *ptr,
													 const NkBeforeUnlinkGoogleCallbackFn cb,
													 NkString **outerror);

	typedef int (*NkAfterUnlinkGoogleCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkAccountGoogle account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkGoogleFn)(const void *ptr,
													const NkAfterUnlinkGoogleCallbackFn cb,
													NkString **outerror);

	typedef int (*NkBeforeUnlinkSteamCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												 NkModule nk, NkAccountSteam account,
												 NkAccountSteam **outaccount, NkString **outerror);

	typedef int (*NkInitializerBeforeUnlinkSteamFn)(const void *ptr,
													const NkBeforeUnlinkSteamCallbackFn cb,
													NkString **outerror);

	typedef int (*NkAfterUnlinkSteamCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
												NkModule nk, NkAccountSteam account, NkString **outerror);

	typedef int (*NkInitializerAfterUnlinkSteamFn)(const void *ptr,
	...
	typedef int (*NkBeforeGetUsersCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											  NkModule nk, NkGetUsersRequest req,
											  NkGetUsersRequest **outreq, NkString **outerror);

	typedef int (*NkInitializerBeforeGetUsersFn)(const void *ptr,
	...
	typedef int (*NkAfterGetUsersCallbackFn)(NkContext ctx, NkLogger logger, NkDb db,
											 NkModule nk, NkUsers users,
											 NkGetUsersRequest req, NkString **outerror);

	typedef int (*NkInitializerAfterGetUsersFn)(const void *ptr,
												const NkAfterGetUsersCallbackFn cb,
												NkString **outerror);

	typedef int (*NkEventCallbackFn)(NkContext ctx, NkLogger logger, NkEvent evt, NkString **outerror);

	typedef int (*NkInitializerEventFn)(const void *ptr,
										const NkEventCallbackFn cb,
										NkString **outerror);

	typedef int (*NkInitializerEventSessionStartFn)(const void *ptr,
													const NkEventCallbackFn cb,
													NkString **outerror);

	typedef int (*NkInitializerEventSessionEndFn)(const void *ptr,
												  const NkEventCallbackFn cb,
												  NkString **outerror);
